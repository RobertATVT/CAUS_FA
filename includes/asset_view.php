            ...
            if ($compliance === null) {
                $wpdb->insert(
                    ...
                    array(
                        ...
                        'CREATOR'=>'compliance',
                        'PRIORITY'=>3,
                        'BODY'=>'You are out of Compliance, to be eligible to purchase new equipment please <a href="https://inside.caus.vt.edu/fixed-assets/compliance-help/" class="get-help">GO HERE</a>',
                    )
                );    
            }
