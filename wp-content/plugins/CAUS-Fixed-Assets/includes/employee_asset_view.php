...
function causfa_load_employee_view() {
    ...
    $result = $wpdb->get_row('SELECT * FROM causfa_custodian WHERE Email = "'.$current_user->user_email.'";');
    ...
    $results = $wpdb->get_results('SELECT * FROM causfa_banner WHERE Custodian = "'.$result->Name.'";');
    $value_total = 0;
